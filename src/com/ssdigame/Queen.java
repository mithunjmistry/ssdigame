...
public class Queen implements Character {
    ...
    Queen(String firstWeapon, String name){
    ...
    public void Walk(int number_of_steps){
        String toDisplay = "The Queen character named ".concat(player_name).concat(" walked ").concat(String.valueOf(number_of_steps).concat(" steps"));
