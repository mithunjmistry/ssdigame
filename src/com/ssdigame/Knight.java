...
public class Knight implements Character {
    ...
    Knight(String firstWeapon, String name){
    ...
    public void Walk(int number_of_steps){
        String toDisplay = "The Knight character named ".concat(player_name).concat(" walked ").concat(String.valueOf(number_of_steps).concat(" steps"));
