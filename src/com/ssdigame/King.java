...
public class King implements Character {
    ...
    King(String firstWeapon, String name){
    ...
    public void Walk(int number_of_steps){
        String toDisplay = "The King character named ".concat(player_name).concat(" walked ").concat(String.valueOf(number_of_steps).concat(" steps"));
